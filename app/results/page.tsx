      ...
      <main className="pt-24 md:pt-32">
        <section className="py-24 md:py-32 bg-bg">
          <div className="mx-auto max-w-[1280px] px-6 md:px-8">
            <div className="max-w-[820px] mx-auto text-center mb-16">
              <Reveal>
              ...
              <Reveal delay={80}>
                <h1 className="mt-5 font-display font-medium tracking-[-0.02em] leading-[1.05] text-[clamp(2.5rem,5vw,5rem)] text-ink">
                  Real students. Real screenshots.
                </h1>
              </Reveal>
              <Reveal delay={160}>
            ...
            <div className="mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {testimonials.map((t, i) => (
                <Reveal key={t.name} delay={(i % 3) * 100}>
                  <article className="group h-full flex flex-col rounded-2xl bg-surface hairline p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-[var(--shadow-lift)]">
                    ...
                    <p className="mt-6 text-[0.975rem] text-ink leading-[1.6] flex-1">
                      &ldquo;{t.quote}&rdquo;
                    </p>
