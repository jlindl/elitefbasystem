  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col">
        ...
        <p className="mt-2 text-[0.9375rem] text-ink-muted leading-[1.55]">
          Got a question about a product, a listing, or your next step?
          Message Jakub directly on WhatsApp.
        </p>
        ...
        <a
          ...
          className="mt-auto pt-5 inline-flex items-center justify-center gap-2 rounded-xl bg-[#25D366] px-6 py-4 text-white font-medium text-[0.9375rem] transition-colors duration-150 hover:bg-[#1da851] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2"
        >
          <WhatsAppIcon size={18} />
          Chat on WhatsApp
        </a>
        <p className="mt-3 font-mono text-[0.7rem] tracking-[0.08em] uppercase text-ink-subtle text-center">
          {WHATSAPP_DISPLAY}
        </p>
      </div>
    </Card>
